...
export const formSchema = z.object({
	...
	propertyType: z.string().default('local'),
	transactionType: z
	...
	state: z
		.string({ required_error: "Veillez sélectionner l'etat du bâtiment" })
		.min(1, { message: "Veillez sélectionner l'etat du bâtiment" }),
	...
	commune: z.string().min(2, { message: 'Veillez sélectionner la commune' }).optional().default(''),
	district: z.string(),
