...
<section class="flex items-center justify-center pb-6">
	...
	>
		<div class="field">
			...
			<Input disabled type="text" name="idType" id="type" value="appartement" />
		</div>
		...
		<div class="field">
			<Form.Field {form} name="title">
				...
				<Form.Description>
					Il est recommandé de ne pas inclure de nombres dans le titre.
				</Form.Description>
		...
		<div>
			<div class="field">
				<Form.Field {form} name="numOfPieces">
					<Form.Control let:attrs>
